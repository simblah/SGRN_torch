...
from nets.network_gcn import Network
...
class resnetGCN(Network):
    ...
    # def load_baseline_cnn(self, state_dict):
    #
    #     # for k, v in state_dict.items():
    #     #     # if k in self.resnet.state_dict():
    #     #     print(k)
    #     Network.load_baseline_dict(self, state_dict)
    #
    ...
    #     # })
    #     #
    #     # self.resnet.load_state_dict({k: v
    #     #     for k, v in state_dict.items()})
